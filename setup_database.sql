/*
  ...
  1. New Tables
    - `projects`
      ...
      - `color` (text) - Hex color code for tile border (e.g., #FF5733)
  ...
  2. Security
    ...
    - Policies allow full CRUD operations for development
    - Future enhancement: Restrict policies to authenticated users only
